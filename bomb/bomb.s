...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp // 为输入的字符串分配空间
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi // 这是答案的地址，%esi 是第二个参数（对应 %rsi ）
  400ee9:	e8 4a 04 00 00       	call   401338 <strings_not_equal>
  400eee:	85 c0                	test   %eax,%eax // 比较
  400ef0:	74 05                	je     400ef7 <phase_1+0x17> // eq，跳转到 400ef7，不引爆
  400ef2:	e8 43 05 00 00       	call   40143a <explode_bomb> // 不等，爆炸
  400ef7:	48 83 c4 08          	add    $0x8,%rsp
  400efb:	c3                   	ret

0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp // 保存原来的栈帧
  400efd:	53                   	push   %rbx // 保存原来的 %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp // 为读入的6个数分配空间
  400f02:	48 89 e6             	mov    %rsp,%rsi // ignore
  400f05:	e8 52 05 00 00       	call   40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp) // 读入的第一个数和 1 比较（首位必须是 1）
  400f0e:	74 20                	je     400f30 <phase_2+0x34> // eq 1，跳转到 400f30
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb> // 不等，爆炸
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34> // ignore
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax // %eax = %rbx - 0x4 （%rbx 的前一个元素）
  400f1a:	01 c0                	add    %eax,%eax // %eax = %eax * 2 （%rbx 的前一个元素的两倍）
  400f1c:	39 03                	cmp    %eax,(%rbx) // %eax 和 %rbx 比较
  400f1e:	74 05                	je     400f25 <phase_2+0x29> // eq，跳转到 400f25，不引爆
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb> // 不等，爆炸
  400f25:	48 83 c3 04          	add    $0x4,%rbx // %rbx = %rbx + 0x4，指向下一个元素
  400f29:	48 39 eb             	cmp    %rbp,%rbx // %rbp 和 %rbx 比较
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b> // 不等，继续循环，说明当前 %rbx 还没有越界
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40> // 相等，越界，跳转到 400f3c，结束循环
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx // %rbx = 栈顶向下 0x4 （第二个元素）
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp // %rbp = 栈顶向下 0x18 （数组越界后的第一个位置）
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>
  400f3c:	48 83 c4 28          	add    $0x28,%rsp
  400f40:	5b                   	pop    %rbx // 恢复原来的 %rbx
  400f41:	5d                   	pop    %rbp // 恢复原来的栈帧
  400f42:	c3                   	ret
...
00000000004015c4 <phase_defused>:
  ...
  401609:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi // 第三个参数
